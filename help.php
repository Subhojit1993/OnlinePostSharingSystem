...
<div class="header1">
		...
		<a href="Blogs.php" style="border:none;">BLOGS </a> <a href="login.php">BACK </a> <a
...
<div class="homebg" id="home-log">
        ...
        <div class="home-left">
            ...
            <h3>If it's created already,
                then click on Take me to my homepage.</h3>
            <h3>Then Share Your posts</h3>
            <h3>Secure Your Account by logged out..!</h3>
